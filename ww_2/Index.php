    ...
    if($num>0){
        ...
        if($pass==$upass){
            ...
            if(strtolower($_SESSION["captcha"])==strtolower($captcha)) {
                ...
                echo "<script language=JavaScript>window.alert('验证码不正确！')</script>";
            }
        }else{
...
<div id="login-form">
    <form method="post">
        <table align="center" width="30%" border="0">
            ...
            <tr>
                <td><input type="text" name="captcha" placeholder="Your yzm" required></td>
                <td><img src="yzm.php" onclick="this.src='yzm.php?'+new Date().getTime();" ></td>
            </tr>
            <tr>
                <td><button type="submit" name="btn_login">登陆</button></td>
            </tr>
            <tr>
                <td><a href="Register.php">前往注册</a></td>
            </tr>
            <tr>
                <td><a href="cark.php">前往刷卡</a></td>
            </tr>
        </table>
    </form>
</div>
