...
//    $res=mysqli_query($link,"SELECT * FROM users WHERE user_id=".$_SESSION['user']);
    ...
    $res=mysqli_query($link,"SELECT * FROM dbtest.users WHERE email='$email' AND code=3");
...
//            $_SESSION['user'] = $row['user_id'];
            echo "<script language=JavaScript>window.alert('该普通用户重置密码成功！密码是：000000')</script>";
